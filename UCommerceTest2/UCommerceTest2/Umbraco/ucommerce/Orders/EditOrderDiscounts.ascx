...
<div class="propertyPane leftAligned">
	<table class="dataList clickable ordersTable discountList" id="discountList" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 25px;">
		<thead>
			<tr>
				<th style="width:31px;"></th>
				<th style="width:25px;"></th>
				<th><%= GetLocalResourceObject("Campaign.Text") %></th>
				<th><%= GetLocalResourceObject("CampaignItem.Text") %></th>
				<th><%= GetLocalResourceObject("Description.Text") %></th>
				<th class="amountCell"><%= GetLocalResourceObject("Total.Text") %></th>
			</tr>
		</thead>
		<tbody>
