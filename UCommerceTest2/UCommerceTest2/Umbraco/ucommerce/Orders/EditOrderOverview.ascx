...
<div class="propertyPane">
	<table class="dataList clickable ordersTable" id="orderList" cellspacing="0" cellpadding="0" width="100%" style="margin-top: 25px;">
		<thead>
			<tr class="headerRow">
				...
				<th>Text</th>
				<% if (IsEditable) { %>
				<th class="amountCell">List Price</th>
				<% } %>
				<th class="amountCell">Unit price</th>
				<th class="quantityCell">Quantity</th>
				<th class="amountCell">VAT</th>
				<th class="amountCell">Total</th>
			</tr>
		</thead>
		<tbody>
