...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentArea" runat="server">
    <div class="propertyPane contentPane noHeader">
						...
						<td style="vertical-align:top; height:20px;" colspan="3">
							...
							<asp:RegularExpressionValidator id="GenerateRegexNumberValidator" runat="server"     
                                ...
                                Display="Dynamic" 
								 Text="*"   
								 ValidationExpression="^\d+$" />
						    <asp:RangeValidator runat="server" Display="Dynamic" ControlToValidate="NumberToGenerateTextBox" MinimumValue="1" MaximumValue="2147483646" ValidationGroup="GenerateVoucherGroup" ErrorMessage="Value must be between 1 and 2147483646" Text="*" />
						</td>
					</tr>
					<tr>
						<td colspan="1">
