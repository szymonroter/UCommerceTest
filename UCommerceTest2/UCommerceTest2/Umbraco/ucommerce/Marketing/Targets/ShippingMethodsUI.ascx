    ...
    <tr>
        <td>
            ...
            <asp:PlaceHolder runat="server" ID="SelectShippingMethodsPlaceHolder" Visible="false">
                <asp:Localize meta:resourcekey="ShippingMethods" runat="server"></asp:Localize>                
                <asp:CheckBoxList runat="server" id="ShippingMethodsCheckBoxList" style="padding-left: 5px;" DataSource="<%# GetShippingMethods() %>" OnDataBound="ShippingMethods_DataBound" DataTextField="Name" DataValueField="Name"/>
            </asp:PlaceHolder>
        </td>
