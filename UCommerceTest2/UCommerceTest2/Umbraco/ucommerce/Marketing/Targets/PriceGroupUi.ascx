    ...
    <tr>
        <td>
            <asp:PlaceHolder runat="server" ID="SelectedPriceGroupPlaceHolder" Visible="true">
                <asp:Localize meta:resourcekey="PriceGroup" runat="server"></asp:Localize>
            ...
            <asp:PlaceHolder runat="server" ID="SelectPriceGroupPlaceHolder" Visible="false">
                <asp:Localize meta:resourcekey="PriceGroup" runat="server"></asp:Localize>                
                <commerce:SafeDropDownList runat="server" id="PriceGroupDropDownList" style="padding-left: 5px;" DataSource="<%# GetPriceGroups() %>" OnDataBound="PriceGroup_DataBound" DataTextField="Name" DataValueField="Name"/>
            </asp:PlaceHolder>
        </td>
