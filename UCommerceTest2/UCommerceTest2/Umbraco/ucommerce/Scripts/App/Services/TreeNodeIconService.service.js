    ...
    return {
        ...
        getNodeIconStyle: function (nodeIconRequest) {
            ...
            if (nodeIconRequest.icon) {
                if (nodeIconRequest.shell == 'Sitecore') {
                    if (nodeIconRequest.iconFolder == 'uCommerce') {
                        var object = {
                        	'background-image': 'url("' + UCommerceClientMgr.BaseUCommerceUrl + 'shell/content/images/ui/' + nodeIconRequest.icon + '")'
                        };
                        return object;
                    } else {
                        return {
                ...
                if (nodeIconRequest.shell == 'Umbraco7') {
                    ...
                    if (nodeIconRequest.iconFolder == 'uCommerce') {
                        return {
                            'background-image': 'url("/umbraco/ucommerce/images/ui/' + nodeIconRequest.icon + '")',
                    ...
                    (lowerCaseIcon.indexOf('.jpg') != -1)) {
                        return {
                            'background-image': 'url("/umbraco/images/umbraco/' + nodeIconRequest.icon + '")',
                            'background-repeat': 'no-repeat',
                            'padding-left': '16px'
                        };
                    }
