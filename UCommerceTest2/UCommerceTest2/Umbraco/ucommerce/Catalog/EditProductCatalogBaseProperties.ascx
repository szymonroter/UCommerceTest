...
<div class="propertyPane">
	<div class="propertyItem">
		...
		<div class="propertyItemContent">
			<asp:CheckBoxList runat="server" id="AllowedPriceGroupsCheckBoxList" SelectionMode="Multiple" DataTextField="Name" DataValueField="PriceGroupId" DataSource="<%# View.PriceGroups %>" OnDataBound="AllowedPriceGroupsCheckBoxList_DataBound"/>
		</div>
	</div>
	<div class="propertyPaneFooter"></div>
</div>
