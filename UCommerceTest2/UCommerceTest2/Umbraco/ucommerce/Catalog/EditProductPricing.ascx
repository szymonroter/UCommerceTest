    ...
    <commerce:BulkEditGridView CssClass="product-price-list" runat="server" ID="PriceGroupGridView" BulkEdit="true" DataSource="<%# PriceGroups %>" ShowHeader="false" DataKeyNames="PriceGroupId" AutoGenerateColumns="false" GridLines="None">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Price">
                <EditItemTemplate>
                    <asp:TextBox class="uc-short-text propertyText mediumWidth amountInput" runat="server" ID="ProductPriceTextBox" Text="<%# GetPriceForPriceGroup(((PriceGroup)Container.DataItem).PriceGroupId) %>"></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField>
                <EditItemTemplate>
