...
<asp:Repeater id="ProductReviewRepeater" runat="server" EnableViewState="true" 
					...
					<table cellspacing="0" style="width:100%; margin-bottom:10px; padding:5px;">
						...
						<tr style="background-color:inherit;">
							<td colspan="6" class="headlineText">
								<h3><%# ProductName(AsProductReview(Container.DataItem)) %>
								</h3>
							</td>
						</tr>
						<% } %>
    ...
    <FooterTemplate>
       ...
       <asp:Label ID="NoReviewsLabel" CssClass="NoReviewsLabel" runat="server" meta:resourcekey="NoReviewsText" Visible="false"/>
    </FooterTemplate>
