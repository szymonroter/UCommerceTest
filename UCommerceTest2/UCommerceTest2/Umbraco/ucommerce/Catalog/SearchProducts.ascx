	...
	<asp:Repeater runat="server" ID="ProductRepeater" EnableViewState="false">
		<HeaderTemplate>
			<table class="dataList" cellspacing="0" width="100%" id="productTable">
				<thead>
					<tr>
						<th><asp:Localize runat="server" meta:resourceKey="SkuNumber" /></th>
						<th><asp:Localize runat="server" meta:resourceKey="Name" /></th>
						<th><asp:Localize runat="server" meta:resourceKey="DisplayName" /></th>
						<th><asp:Localize runat="server" meta:resourceKey="DisplayOnSite" /></th>
						<th><asp:Localize runat="server" meta:resourceKey="Category" /></th>
						<th><asp:Localize runat="server" meta:resourceKey="ProductDefinition" /></th>
