                        ...
                        <EditItemTemplate>
                            <asp:PlaceHolder runat="server" Visible="<%# ((Product)Container.DataItem).ProductId > 0 %>">
								<div class="variantOptions" style="width:75px; display:inline-block;">
									...
									<a href="#" onclick="UCommerceClientMgr.openModal('<%# GetVariantDescriptionEditorUrl((Product)Container.DataItem)%>', 'Edit Description', 650, 450); return false;"><img src="../images/ui/note_edit.png" alt="Edit description" /></a>
